  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-700/50 rounded-xl p-4">
      ...
      <div className="space-y-4">
        {/* New chairman */}
        {hasNewChairman && (
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg px-3 py-2.5 -mx-1">
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
              </svg>
              <div>
                <p className="text-[11px] text-purple-600 dark:text-purple-400">Ny ordförande</p>
            ...
            <ul className="space-y-1.5 ml-5">
              {data.avgaendeLedamoter.map((name, index) => (
                <li key={index} className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400 line-through">{name}</span>
                </li>
              ))}
            </ul>
          </div>

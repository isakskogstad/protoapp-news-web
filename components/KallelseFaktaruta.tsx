...
export default function KallelseFaktaruta({ data }: KallelseFaktarutaProps) {
  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/50 rounded-xl p-4">
      ...
      {/* Main info card */}
      <div className="bg-blue-100 dark:bg-blue-900/40 rounded-lg px-4 py-3 mb-3">
        <div className="flex items-start gap-3">
          {/* Calendar visual */}
          <div className="w-12 h-12 bg-white dark:bg-blue-950 rounded-lg flex flex-col items-center justify-center shadow-sm flex-shrink-0">
            <span className="text-[10px] font-medium text-blue-500 dark:text-blue-400 uppercase">
              {getMonthAbbr(data.datum)}
            </span>
            <span className="text-lg font-bold text-blue-900 dark:text-blue-100 -mt-0.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            {data.tid && (
              <p className="text-sm text-blue-700 dark:text-blue-300 flex items-center gap-1.5 mt-0.5">
      ...
      {data.plats && (
        <div className="flex items-start gap-2.5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[11px] text-blue-600 dark:text-blue-400">Plats</p>
